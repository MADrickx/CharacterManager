# Character Manager
# Made by : Audric Skivée & Ludovic Vostès (BeCode@hamiltons 5.32)

the essence of this project is to learn Javascript, and fetch some datas from a distant server, and manipul them to display the result in form of cards.
